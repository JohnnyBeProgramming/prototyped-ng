...
;angular.module('prototyped.ng.samples.views', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('samples/main.tpl.html',
    '<div class=container style="width: 100%"><div class=row><div class=col-md-12><h4>Prototyped Sample Code <small>Beware, code monkeys at play... ;)</small></h4><hr><p ui:view=body>.....</p><hr></div></div></div>');
