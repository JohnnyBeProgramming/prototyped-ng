            ...
            (function (_data) {
                var ChanceDataGenerator = (function () {
                    function ChanceDataGenerator() {
                        console.debug(' - Chance: ', typeof Chance);
                ...
                var SampleDataController = (function () {
                    ...
                    SampleDataController.prototype.init = function () {
                        ...
                        this._chance = new ChanceDataGenerator();
...
;angular.module('prototyped.ng.samples.views', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('samples/sampleData/main.tpl.html',
    ...
    '                                .sample-list ul li {\n' +
    '                                    list-style: square;\n' +
    '                                }</style><div class="row sample-container"><div class=col-md-3><div class="thumbnail sample-list"><h5>Basics</h5><ul class=toc_section><li><a href="" ng-click="sampleData.addColumn(sampleData.context, { id: \'Boolean\', val: \'{bool}\', type:\'chance\'})">bool</a></li><li><a href="" ng-click="sampleData.addColumn(sampleData.context, { id: \'Character\', val: \'{character}\', type:\'chance\'})">character</a></li><li><a href="" ng-click="sampleData.addColumn(sampleData.context, { id: \'Floating\', val: \'{floating}\', type:\'chance\'})">floating</a></li><li><a href="" ng-click="sampleData.addColumn(sampleData.context, { id: \'Integer\', val: \'{integer}\', type:\'chance\'})">integer</a></li><li><a href="" ng-click="sampleData.addColumn(sampleData.context, { id: \'Natural\', val: \'{natural}\', type:\'chance\'})">natural</a></li><li><a href="" ng-click="sampleData.addColumn(sampleData.context, { id: \'String\', val: \'{string}\', type:\'chance\'})">string</a></li></ul></div><div class="thumbnail sample-list"><h5>Text</h5><ul class=toc_section><li><a href=#paragraph>paragraph</a></li><li><a href=#sentence>sentence</a></li><li><a href=#syllable>syllable</a></li><li><a href=#word>word</a></li></ul></div><div class="thumbnail sample-list"><h5>Finance</h5><ul class=toc_section><li><a href=#cc>cc</a></li><li><a href=#cc_type>cc_type</a></li><li><a href=#currency>currency</a></li><li><a href=#currency_pair>currency_pair</a></li><li><a href=#dollar>dollar</a></li><li><a href=#exp>exp</a></li><li><a href=#exp_month>exp_month</a></li><li><a href=#exp_year>exp_year</a></li></ul></div></div><div class=col-md-3><div class="thumbnail sample-list"><h5>Person</h5><ul class=toc_section><li><a href=#age>age</a></li><li><a href=#birthday>birthday</a></li><li><a href=#cpf>cpf</a></li><li><a href=#first>first</a></li><li><a href=#gender>gender</a></li><li><a href=#last>last</a></li><li><a href=#name>name</a></li><li><a href=#prefix>prefix</a></li><li><a href=#ssn>ssn</a></li><li><a href=#suffix>suffix</a></li></ul></div><div class="thumbnail sample-list"><h5>Miscellaneous</h5><ul class=toc_section><li><a href=#dice>dice</a></li><li><a href=#guid>guid</a></li><li><a href=#hash>hash</a></li><li><a href=#hidden>hidden</a></li><li><a href=#n>n</a></li><li><a href=#normal>normal</a></li><li><a href=#radio>radio</a></li><li><a href=#rpg>rpg</a></li><li><a href=#tv>tv</a></li><li><a href=#unique>unique</a></li><li><a href=#weighted>weighted</a></li></ul></div></div><div class=col-md-3><div class="thumbnail sample-list"><h5>Web</h5><ul class=toc_section><li><a href=#color>color</a></li><li><a href=#domain>domain</a></li><li><a href=#email>email</a></li><li><a href=#fbid>fbid</a></li><li><a href=#google_analytics>google_analytics</a></li><li><a href=#hashtag>hashtag</a></li><li><a href=#ip>ip</a></li><li><a href=#ipv6>ipv6</a></li><li><a href=#klout>klout</a></li><li><a href=#tld>tld</a></li><li><a href=#twitter>twitter</a></li><li><a href=#url>url</a></li></ul></div><div class="thumbnail sample-list"><h5>Time</h5><ul class=toc_section><li><a href=#ampm>ampm</a></li><li><a href=#date>date</a></li><li><a href=#hammertime>hammertime</a></li><li><a href=#hour>hour</a></li><li><a href=#millisecond>millisecond</a></li><li><a href=#minute>minute</a></li><li><a href=#month>month</a></li><li><a href=#second>second</a></li><li><a href=#timestamp>timestamp</a></li><li><a href=#year>year</a></li></ul></div></div><div class=col-md-3><div class="thumbnail sample-list"><h5>Mobile</h5><ul class=toc_section><li><a href=#android_id>android_id</a></li><li><a href=#apple_token>apple_token</a></li><li><a href=#bb_pin>bb_pin</a></li><li><a href=#wp7_anid>wp7_anid</a></li><li><a href=#wp8_anid2>wp8_anid2</a></li></ul></div><div class="thumbnail sample-list"><h5>Location</h5><ul class=toc_section><li><a href=#address>address</a></li><li><a href=#altitude>altitude</a></li><li><a href=#areacode>areacode</a></li><li><a href=#city>city</a></li><li><a href=#coordinates>coordinates</a></li><li><a href=#country>country</a></li><li><a href=#depth>depth</a></li><li><a href=#geohash>geohash</a></li><li><a href=#latitude>latitude</a></li><li><a href=#longitude>longitude</a></li><li><a href=#phone>phone</a></li><li><a href=#postal>postal</a></li><li><a href=#province>province</a></li><li><a href=#state>state</a></li><li><a href=#street>street</a></li><li><a href=#zip>zip</a></li></ul></div></div></div></div><div ng-if="!sampleData.edit && sampleData.context.args.length" class=col-md-9><div class=pull-right style="width: 200px"><input id=ex1 type=range min=0 max=100 ng-model=sampleData.context.rows ng-blur="sampleData.updateProfile(sampleData.context, true)"></div><div class=pull-right style="width: 64px">Rows: <b>{{ sampleData.context.rows }}</b></div><h5>Results View <small ng:if=sampleData.context.resp.length>( {{ sampleData.context.resp.length }} total ) | <a href="" ng-click=sampleData.clearData(sampleData.context)><i class="fa fa-trash"></i> Clear</a></small></h5><table class=table><thead><tr><th ng-repeat="arg in sampleData.context.args">{{ arg.id }}</th></tr></thead><tbody><tr ng-if=!sampleData.context.resp><td colspan="{{ sampleData.context.args.length }}"><em>Nothing to show yet. Fetch some data first...</em></td></tr><tr ng-repeat="row in sampleData.context.resp"><td ng-repeat="arg in sampleData.context.args">{{ row[arg.id] }}</td></tr></tbody></table></div></div></div></div></div>');
